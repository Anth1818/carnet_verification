...
export function Verification({ id, worker }: IVerificationProps) {
const { name, cargo, department, status } = worker as { name: string, cargo: string, department: string, status: string };
